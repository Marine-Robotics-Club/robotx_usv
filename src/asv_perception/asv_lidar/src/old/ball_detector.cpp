...
public:
    PointCloudClusterer() : Node("ball_detector") {
        ...
        RCLCPP_INFO(this->get_logger(), "===== PointCloudClusterer Parameters =====");
        RCLCPP_INFO(this->get_logger(), "min_x_size: %.3f", min_x_size_);
        RCLCPP_INFO(this->get_logger(), "min_y_size: %.3f", min_y_size_);
        RCLCPP_INFO(this->get_logger(), "min_z_size: %.3f", min_z_size_);
        RCLCPP_INFO(this->get_logger(), "max_x_size: %.3f", max_x_size_);
        RCLCPP_INFO(this->get_logger(), "max_y_size: %.3f", max_y_size_);
        RCLCPP_INFO(this->get_logger(), "max_z_size: %.3f", max_z_size_);
        RCLCPP_INFO(this->get_logger(), "min_detect_dist: %.3f", min_detect_dist_);
        RCLCPP_INFO(this->get_logger(), "max_detect_dist: %.3f", max_detect_dist_);
        RCLCPP_INFO(this->get_logger(), "cluster_tolerance: %.3f", cluster_tolerance_);
