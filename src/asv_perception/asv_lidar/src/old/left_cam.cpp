...
public:
    CameraDriver() : Node("camera_driver")
    {
        ...
        raw_pub_ = this->create_publisher<sensor_msgs::msg::Image>("vision/cam/left/raw", 1);
        lower_res_pub_ = this->create_publisher<sensor_msgs::msg::Image>("vision/cam/left/lower_res", 1);
