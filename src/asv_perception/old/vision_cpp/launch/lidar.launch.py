...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            package='vision_cpp',
            executable='vision_obstacle_avoidance_node',
            name='vision_obstacle_avoidance_node',
            output='screen',
        ),
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([os.path.join(yolov9_dir, 'yolov9_all.launch.py')])
        ),
    ])
