...
{
public:
    YoloEstimatorNode() : Node("yolo_estimator_node_left")
    {
        ...
        position_pub_ = this->create_publisher<fau_msgs::msg::ObjectPositionArray>(
            "/vision/output/position_estimates/left", 10);
    }
...
private:
                                 ...
                                 double &angle, double &magnitude, double reference_width, double reference_distance)
    {
        ...
        const double fov_x = 94.5 * (M_PI / 180.0); // Horizontal FOV in radians
