...
public:
    PointCloudClusterer() : Node("dock_detector") {
        declare_parameters();
        ...
        buoy_detected_pub_= this->create_publisher<lidar_msgs::msg::BuoyDetected>("/vision/output/dock_detected",1);
    }
...
private:
    ...
    void pointcloud_callback(const sensor_msgs::msg::PointCloud2::SharedPtr msg) {
		...
		buoy_detected_msg.name.push_back("dock[" + std::to_string(cluster_id) + "]");
