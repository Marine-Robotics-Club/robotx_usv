...
public:
    PointCloudClusterer() : Node("dock_bay_detector") {
        declare_parameters();
        ...
        cluster_pub_ = this->create_publisher<sensor_msgs::msg::PointCloud2>("clustered_points_dock", 10);
        buoy_detected_pub_= this->create_publisher<lidar_msgs::msg::BuoyDetected>("/vision/output/dock_bay_detected",0);
    }
...
private:
    ...
    void declare_parameters() {
        ...
        this->declare_parameter<double>("min_x_size", 4.0);
        this->declare_parameter<double>("min_y_size", 4.0);
        this->declare_parameter<double>("min_z_size", 1.5);
        this->declare_parameter<double>("max_x_size", 10.0);
        this->declare_parameter<double>("max_y_size", 10.0);
        this->declare_parameter<double>("max_z_size", 6.0);
    ...
    void pointcloud_callback(const sensor_msgs::msg::PointCloud2::SharedPtr msg) {
		...
		buoy_detected_msg.name.push_back("dock_bay[" + std::to_string(cluster_id) + "]");
