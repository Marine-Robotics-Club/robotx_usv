...
public:
    CameraDriver() : Node("camera_driver")
    {
        ...
        const std::string target_camera_path = "platform-3610000.usb-usb-0:3.1.3:1.0";
        ...
        raw_pub_ = this->create_publisher<sensor_msgs::msg::Image>("vision/cam/front/raw", 10);
        lower_res_pub_ = this->create_publisher<sensor_msgs::msg::Image>("vision/cam/front/lower_res", 10);
