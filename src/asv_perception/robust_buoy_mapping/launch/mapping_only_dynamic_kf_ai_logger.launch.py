...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            executable='dynamic_kf_ai_logger_node',
            name='dynamic_kf_ai_logger_node',
            parameters=[{
                'asv': asv,
                ...
                'ai_log_enabled': True,
                'ai_log_csv': '/home/highlevel/roboboat_vehicle_data/processed/zed_kf_teacher_candidates.csv',
                'ai_logging_gate': 40.0,
            }],
            output='screen'
        ),
