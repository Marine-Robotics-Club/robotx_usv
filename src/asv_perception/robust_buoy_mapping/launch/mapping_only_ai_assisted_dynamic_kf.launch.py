...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'error_csv',
            default_value='/home/highlevel/roboboat_vehicle_data/logs/ai_assisted_dynamic_kf_mapping_error.csv'
        ),

        Node(
            package='robust_buoy_mapping',
            executable='dynamic_kf_ai_assisted_mapper_node',
            name='dynamic_kf_ai_assisted_mapper_node',
            parameters=[{
                'asv': asv,
                ...
                'delete_confirmed_after_missing_s': 20.0,
                'birth_min_separation_m': 3.0,
                ...
                'ai_enabled': True,
                'pair_model_path': '/home/highlevel/roboboat_usv/src/asv_perception/robust_buoy_mapping/models/self_supervised/pair_reliable_update_rf.joblib',
                'sigma_model_path': '/home/highlevel/roboboat_usv/src/asv_perception/robust_buoy_mapping/models/self_supervised/measurement_sigma_rf.joblib',
                'birth_model_path': '/home/highlevel/roboboat_usv/src/asv_perception/robust_buoy_mapping/models/self_supervised/birth_reliable_rf.joblib',
                'p_update_threshold': 0.55,
                'p_birth_threshold': 0.55,
                'ai_score_weight': 8.0,
